# ==============================================================================
# run_spatial_vs_nonspatial_w_unif_T_25_A_510_parallel.R
...
# ------ 1. Dados ------
source("Geracao_w_unif_T_25_A_510.R")
...
run_model <- function(model_type, output_dir) {
  ...
  samples <- runMCMC(Cmcmc,niter=niter,nburnin=nburnin,nchains=nchains,thin=1,
...
output_dir <- "C:/Users/vlara/OneDrive/Estatistica UFMG/Mestrado/Pesquisa/Simulacao/main/resultados_spatial_vs_nonspatial_w_unif_T_25_A_510"
